...
- **Persistent local state:** project-scoped session history stored per OMP profile, and saved provider selection, hidden rows, position, density, polling interval, visibility, and theme tokens.
